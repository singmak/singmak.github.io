...
I created another Lambda function with Serverless Framework and did some tests. I put the source [here](git@github.com:singmak/aws-lambda-cold-start-test.git)
