...
[![Project structure](./images/cdk-express-project-structure.png)](./images/cdk-express-project-structure.png)
...
[![CDK Deploy](./images/cdk-express-deploy.png)](./images/cdk-express-deploy.png)

input `y` and enter to continue

If the deployment is successful, you should see something similar to this:
[![CDK Deploy Success](./images/cdk-express-deploy-success.png)](./images/cdk-express-deploy-success.png)
