...
1. Apply data schema changes to production database (make sure it's backend compatible with current API service)
2. Deploy API service (make sure it's backend compatible with current web application and also automatically handle data migration for new data)
